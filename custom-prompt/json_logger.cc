...
void log_debug(char const* file, char const* func, std::intmax_t line, char const *msg, std::vector<std::pair<JSONKey, JSONValue>> msg_args)
{
    ...
    oss << ",\"source\":" LEFT_CURLY_BRACKET "\"file\":\"" << file << "\",\"func\":\"" << func << "\",\"line\":" << line << RIGHT_CURLY_BRACKET;
        oss << ",\"msg\":\"" << msg << "\"";
...
int main(void)
{
    LOG_DEBUG("here is something");
    LOG_DEBUG("here is another", {{"key", "val"}, {"123", 45}, {"final", 4.4}});
}
