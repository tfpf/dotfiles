...
:param args: Enable light mode if non-empty, and dark mode otherwise.
    ...
    def __init__(self, *args):
        ...
        self.code = tk.Text(
            ...
            selectforeground='#FFFFFF', inactiveselectbackground='#079486', font=('RecMonoCasual Nerd Font', 12)
        )
        ...
        self.size = tk.Entry(
            self, bg='#333333', fg='#FFFFFF', insertbackground='#F0EC8C', selectbackground='#079486',
            selectforeground='#FFFFFF', font=('RecMonoCasual Nerd Font', 12)
        )
        ...
        wrapbtn = tk.Checkbutton(
            self, font=('RecMonoCasual Nerd Font', 12), text=' Wrap Text', activebackground='#333333',
        ...
        typefacecbox = ttk.Combobox(
            self, font=('RecMonoCasual Nerd Font', 12), state='readonly', textvariable=self.typeface,
            values=('Cochineal', 'RecMonoCasual Nerd Font', 'Angelic')
        )
        self.option_add('*TCombobox*Listbox.font', ('RecMonoCasual Nerd Font', 12))
